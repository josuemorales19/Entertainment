    ...
    <div class="container">
        <div class="row">
            <div class="card col-md-12">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">{{ $music->year }}</h6>
                    <p class="card-text">By: {{ $music->artist }}</p>
                </div>
            ...
            <div class="col-md-12">
                ...
                @if (count($music->comments) == 0 || $music->comments == null || empty($music->comments))
